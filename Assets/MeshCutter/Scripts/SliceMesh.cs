...
public class SliceMesh : MonoBehaviour {
    ...
    public void Slice()
    {
        SliceObjects(new Vector3(-3.33f, 6.34f, -9.43f), new Vector3(0.72f, -0.11f, -0.69f));
        //SliceObjects(new Vector3(-4.32f, 6.18f, -8.69f), new Vector3(0.69f, -0.17f, -0.70f));
    }
    ...
    void SeparateMeshes(List<Transform> positives, List<Transform> negatives, Vector3 worldPlaneNormal)
    {
        ...
        for (i = 0; i < positives.Count; ++i)
        {
            ...
            Destroy(positives[i].gameObject);
        }
